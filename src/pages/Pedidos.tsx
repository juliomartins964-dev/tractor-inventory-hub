...
const Pedidos = () => {
  ...
  return (
    <>
      <div>
        <h2 className="text-xl sm:text-2xl font-bold text-foreground">Pedidos em Carteira</h2>
        <p className="text-xs sm:text-sm text-muted-foreground">Alocação Fábrica</p>
      </div>
